 ...
 */class oe extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,s)=>{const i=s?.renderBefore??t;let n=i._$litPart$;if(void 0===n){const e=s?.renderBefore??null;i._$litPart$=n=new X(t.insertBefore(P(),e),e,void 0,s??{})}return n._$AI(e),n})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return F}}oe._$litElement$=!0,oe.finalized=!0,ae.litElementHydrateSupport?.({LitElement:oe});const ce=ae.litElementPolyfillSupport;ce?.({LitElement:oe}),(ae.litElementVersions??=[]).push("4.2.2");const le={sensors:{battery:"_batterie",activity_mode:"_aktivitatsmodus",progress:"_fortschritt",area:"_bereich",mowing_speed:"_mahgeschwindigkeit",blade_height:"_schnitthohe",total_time:"_gesamtzeit",elapsed_time:"_vergangene_zeit",left_time:"_verbleibende_zeit",satellites_robot:"_satelliten_roboter",l1_satellites:"_l1_satelliten_co_viewing",l2_satellites:"_l2_satelliten_co_viewing",rtk_position:"_rtk_position",position_type:"_typ_der_geratepositionierung",wifi_rssi:"_wi_fi_rssi",ble_rssi:"_ble_rssi",mnet_rssi:"_mobilfunk_rssi",connect_type:"_verbindungsart",latitude:"_breitengrad",longitude:"_langengrad",work_area:"_arbeitsbereich",error_code:"_letzter_fehlercode",error_message:"_letzte_fehlermeldung",error_time:"_letzter_fehlerzeitpunkt",blade_used_time:"_messernutzungszeit",blade_warn_time:"_messerverschleiss_warnzeit",total_distance:"_gesamtkilometerstand",battery_cycles:"_batteriezyklen",camera_brightness:"_kamera_helligkeit",non_work_hours:"_arbeitsfreie_zeit",task_duration:"_aufgabendauer",task_area:"_aufgabenbereich_area_1"},buttons:{release_dock:"_abdocken",cancel_task:"_aktuelle_aufgabe_abbrechen",sync_map:"_synchronisiere_karte",sync_schedule:"_synchronisiere_zeitplan",resync_rtk:"_synchronisiere_rtk_und_ladestation",relocate_dock:"_ladestation_umsetzen",nudge_forward:"_notfall_schub_vorwarts",nudge_back:"_notfall_schub_ruckwarts",nudge_left:"_notfall_schub_links",nudge_right:"_notfall_schub_rechts",restart:"_restart_mower"},selects:{charge_mode:"_aufladungsmodus",path_order:"_ausfuhrungsreihenfolge_des_pfades",obstacle_mode:"_modus_der_hinderniserkennung",nav_mode:"_navigationsmodus",border_laps:"_patrouillenrunden_fur_den_seitlichen_rasenschnitt",nogo_laps:"_patrouillenrunden_fur_mahen_von_no_go_zonen",angle_mode:"_wegwinkel_modus",turn_mode:"_wendemodus"},numbers:{working_speed:"_aufgabengeschwindigkeit",start_progress:"_fortschritt_beim_start",cutting_angle:"_kreuzungswinkel",blade_height:"_schnitthohe",path_spacing:"_wegabstand",path_angle:"_wegwinkel"},switches:{rain_mowing:"_regenerkennung_beim_mahen",rain_robot:"_regenerkennung_roboter",side_led:"_seitenlicht",schedule_updates:"_updates_ein_ausschalten"}};function de(e){return{sensors:"sensor",buttons:"button",selects:"select",numbers:"number",switches:"switch"}[e]||e}const he={single_grid:"Einzelbahn",double_grid:"Doppelbahn",segment_grid:"Segmentbahn",no_grid:"Ohne Bahn",zero_turn:"Nullwendung",multipoint:"Mehrpunkt",direct_touch:"Direktkontakt",slow_touch:"Langsamer Kontakt",less_touch:"Weniger Kontakt",no_touch:"Kein Kontakt",sensitive:"Empfindlich",direct:"Direkt",follow_perimeter:"Randverfolgung",border_first:"Rand zuerst",grid_first:"Bahn zuerst",relative_angle:"Relativer Winkel",absolute_angle:"Absoluter Winkel",random_angle:"Zufälliger Winkel",none:"Keine",one:"1 Runde",two:"2 Runden",three:"3 Runden",four:"4 Runden"};function pe(e,t){const s=function(e,t){return e&&t&&e.states[t]||null}(e,t);return s?s.state:null}function ue(e,t){const s=pe(e,t);if(null===s||"unknown"===s||"unavailable"===s)return null;const i=parseFloat(s);return isNaN(i)?null:i}const _e={status:!0,controls:!0,map_and_zones:!0,camera:!0,settings:!0,schedule:!0},ge={status:"Status",controls:"Steuerung",map_and_zones:"Karte & Bereiche",camera:"Kamera",settings:"Einstellungen",schedule:"Zeitplan"};customElements.define("mammotion-card-editor",class extends oe{static get properties(){return{hass:{attribute:!1},_config:{state:!0}}}setConfig(e){this._config={...e}}_valueChanged(e){if(!this._config||!this.hass)return;const t=e.target,s=t.configValue;let i=e.detail?.value??t.value;"mode"===s&&(i=t.value);const n={...this._config,[s]:i};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}_moduleChanged(e){const t=e.target.configValue,s=e.target.checked,i={..._e,...this._config.modules,[t]:s},n={...this._config,modules:i};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}render(){if(!this.hass||!this._config)return D``;const e=Object.keys(this.hass.states).filter(e=>e.startsWith("lawn_mower.")).sort(),t={..._e,...this._config.modules};return D`
    ...
    `}render(){if(!this.hass||!this._config)return D`<ha-card><div class="card-content"><div class="loading">Lade...</div></div></ha-card>`;if(!this.hass.states[this._config.entity])return D`<ha-card><div class="card-content">
        ...
        ><svg viewBox="0 0 24 24"><path fill="currentColor" d="M17.65 6.35A7.958 7.958 0 0012 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08A5.99 5.99 0 0112 18c-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg></button>`:"",o=this._entities.buttons.sync_schedule?D`<button
      ...
      <ha-card>
        <div class="card-content">
          ...
          ${!1!==r.map_and_zones?this._renderSection("map_and_zones","mdi:map-marker-radius","Karte & Bereiche",this._renderMapAndZonesContent(e),a):""}
    ...
    `}_renderStatus(e,t,s,i,n){const r=ue(this.hass,this._entities.sensors.progress),a=pe(this.hass,this._entities.sensors.error_message),o=ue(this.hass,this._entities.sensors.wifi_rssi),c=ue(this.hass,this._entities.sensors.satellites_robot),l=pe(this.hass,this._entities.sensors.rtk_position);return D`
      <div class="status-header">
        ...
        <div class="status-info">
          ...
          ${"error"===t&&a?D`<div class="error-msg">${a}</div>`:""}
        </div>
      ...
      ${n?D`
            <div class="status-details">
              ...
              ${null!==o?D`<span class="detail-badge" title="WiFi ${o} dBm">
                    <ha-icon icon=${this._signalIcon(o)}></ha-icon> ${o} dBm
                  </span>`:""}
              ${null!==r&&"mowing"===t?D`<span class="detail-badge" title="Fortschritt">
    ...
    `}_renderMapAndZonesContent(e){const t=ue(this.hass,this._entities.sensors.latitude),s=ue(this.hass,this._entities.sensors.longitude),i=ue(this.hass,this._entities.sensors.satellites_robot),n=this._entities.areas;return D`
      ${null!==t&&null!==s?D`
            <div id="mmc-map" class="map-container"></div>
            ${null!==i?D`<div class="map-info"><ha-icon icon="mdi:satellite-variant" style="--mdc-icon-size:14px"></ha-icon> ${i} Satelliten · ${t.toFixed(5)}, ${s.toFixed(5)}</div>`:""}
          `:D`<div class="map-placeholder">Keine GPS-Position verfügbar</div>`}

      ${n&&n.length>0?D`
            <div class="zone-list">
              ${n.map(e=>{const t=this.hass.states[e],s=!t||"unavailable"===t.state,i="on"===t?.state,n=t?.attributes?.friendly_name||"";let r;if(n&&n!==e)r=n.replace(/^[A-Za-z]+-[A-Z0-9]+\s+/,""),r===n&&(r=n.replace(/^.*?\s+(Bereich)/i,"$1"));else{const t=e.match(/bereich_(\w+)$/);r=t?`Bereich ${t[1].replace(/_/g,".")}`:"Bereich"}return D`
          ...
          `:D`<div class="empty-hint">Keine Bereiche gefunden</div>`}
    `}_renderCameraContent(){const e=this._entities.camera;if(!e||!this.hass.states[e])return D`<div class="camera-placeholder">
        <ha-icon icon="mdi:camera-off"></ha-icon>
        <span>Keine Kamera verfügbar</span>
      </div>`;if(!this._isSectionOpen("camera"))return"";const t=this.hass.states[e],s=t.state;if("unavailable"===s||"idle"===s)return D`<div class="camera-placeholder" @click=${()=>this._showMoreInfo(e)}>
        <ha-icon icon="mdi:camera-off"></ha-icon>
        <span>Kamera verfügbar wenn der Mäher fährt</span>
      </div>`;const i=t.attributes?.access_token;return D`
      <div class="camera-container" @click=${()=>this._showMoreInfo(e)}>
        <img
          src=${i?`/api/camera_proxy/${e}?token=${i}`:`/api/camera_proxy/${e}`}
          alt="Mäher-Kamera"
          class="camera-image"
          @error=${e=>{e.target.style.display="none";const t=e.target.parentElement.querySelector(".camera-fallback");t&&(t.style.display="flex")}}
        />
